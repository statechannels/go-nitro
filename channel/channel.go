...
func (c *Channel) MakePayment(payee types.Destination, amount *big.Int, secretKey *[]byte) (state.SignedState, error) {
	...
	if !c.PostFundComplete() {
		return state.SignedState{}, errors.New("Channel not ready")
	}
