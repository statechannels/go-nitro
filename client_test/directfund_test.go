...
func TestDirectFund(t *testing.T) {
	...
	chainA := chainservice.NewSimulatedBackendChaneService(sim, sim, na, naAddress, ethAccounts[0])
	chainB := chainservice.NewSimulatedBackendChaneService(sim, sim, na, naAddress, ethAccounts[1])
