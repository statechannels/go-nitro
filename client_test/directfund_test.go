...
func TestDirectFund(t *testing.T) {
	...
	chainA := chainservice.NewSimulatedBackendChaneService(sim, sim, na, naAddress, authA)
	chainB := chainservice.NewSimulatedBackendChaneService(sim, sim, na, naAddress, authB)
