...
In most cases, the channel would be finalized and defunded [off chain](./0005-funding-a-channel.md##fund-from-an-existing-channel), and no contract calls are necessary.
