...
// NitroAdjudicatorInstance represents a deployed instance of the NitroAdjudicator contract.
type NitroAdjudicatorInstance struct {
	NitroAdjudicator
...
func (i *NitroAdjudicatorInstance) Backend() bind.ContractBackend {
	return i.backend
}
...
// NewNitroAdjudicator creates a new instance of NitroAdjudicator.
func NewNitroAdjudicator() (*NitroAdjudicator, error) {
	parsed, err := NitroAdjudicatorMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
	code := common.Hex2Bytes(NitroAdjudicatorMetaData.Bin)
	return &NitroAdjudicator{abi: *parsed, deployCode: code}, nil
}

func (_NitroAdjudicator *NitroAdjudicator) DeployCode() []byte {
	return _NitroAdjudicator.deployCode
}

func (_NitroAdjudicator *NitroAdjudicator) PackConstructor() ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("")
}

// Challenge is a free data retrieval call binding the contract method 0x8286a060.
//
...
func (_NitroAdjudicator *NitroAdjudicator) PackChallenge(fixedPart INitroTypesFixedPart, proof []INitroTypesSignedVariablePart, candidate INitroTypesSignedVariablePart, challengerSig INitroTypesSignature) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("challenge", fixedPart, proof, candidate, challengerSig)
}

// Checkpoint is a free data retrieval call binding the contract method 0x6d2a9c92.
//
...
func (_NitroAdjudicator *NitroAdjudicator) PackCheckpoint(fixedPart INitroTypesFixedPart, proof []INitroTypesSignedVariablePart, candidate INitroTypesSignedVariablePart) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("checkpoint", fixedPart, proof, candidate)
}
...
func (_NitroAdjudicator *NitroAdjudicator) PackComputeReclaimEffects(sourceAllocations []ExitFormatAllocation, targetAllocations []ExitFormatAllocation, indexOfTargetInSource *big.Int) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("compute_reclaim_effects", sourceAllocations, targetAllocations, indexOfTargetInSource)
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackComputeReclaimEffects(data []byte) ([]ExitFormatAllocation, error) {
	out, err := _NitroAdjudicator.abi.Unpack("compute_reclaim_effects", data)
...
func (_NitroAdjudicator *NitroAdjudicator) PackComputeTransferEffectsAndInteractions(initialHoldings *big.Int, allocations []ExitFormatAllocation, indices []*big.Int) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("compute_transfer_effects_and_interactions", initialHoldings, allocations, indices)
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackComputeTransferEffectsAndInteractions(data []byte) (struct {
	NewAllocations     []ExitFormatAllocation
	AllocatesOnlyZeros bool
	ExitAllocations    []ExitFormatAllocation
	TotalPayouts       *big.Int
}, error) {
	out, err := _NitroAdjudicator.abi.Unpack("compute_transfer_effects_and_interactions", data)
...
// Conclude is a free data retrieval call binding the contract method 0xee049b50.
//
...
func (_NitroAdjudicator *NitroAdjudicator) PackConclude(fixedPart INitroTypesFixedPart, candidate INitroTypesSignedVariablePart) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("conclude", fixedPart, candidate)
}

// ConcludeAndTransferAllAssets is a free data retrieval call binding the contract method 0xec346235.
//
...
func (_NitroAdjudicator *NitroAdjudicator) PackConcludeAndTransferAllAssets(fixedPart INitroTypesFixedPart, candidate INitroTypesSignedVariablePart) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("concludeAndTransferAllAssets", fixedPart, candidate)
}

// Deposit is a free data retrieval call binding the contract method 0x2fb1d270.
//
// Solidity: function deposit(address asset, bytes32 channelId, uint256 expectedHeld, uint256 amount) payable returns()
func (_NitroAdjudicator *NitroAdjudicator) PackDeposit(asset common.Address, channelId [32]byte, expectedHeld *big.Int, amount *big.Int) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("deposit", asset, channelId, expectedHeld, amount)
}
...
func (_NitroAdjudicator *NitroAdjudicator) PackHoldings(arg0 common.Address, arg1 [32]byte) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("holdings", arg0, arg1)
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackHoldings(data []byte) (*big.Int, error) {
	out, err := _NitroAdjudicator.abi.Unpack("holdings", data)
...
// Reclaim is a free data retrieval call binding the contract method 0xd3c4e738.
//
// Solidity: function reclaim((bytes32,bytes32,bytes,uint256,uint256,bytes32,bytes,uint256) reclaimArgs) returns()
func (_NitroAdjudicator *NitroAdjudicator) PackReclaim(reclaimArgs IMultiAssetHolderReclaimArgs) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("reclaim", reclaimArgs)
}
...
func (_NitroAdjudicator *NitroAdjudicator) PackStateIsSupported(fixedPart INitroTypesFixedPart, proof []INitroTypesSignedVariablePart, candidate INitroTypesSignedVariablePart) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("stateIsSupported", fixedPart, proof, candidate)
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackStateIsSupported(data []byte) (struct {
	Arg  bool
	Arg0 string
}, error) {
	out, err := _NitroAdjudicator.abi.Unpack("stateIsSupported", data)
...
func (_NitroAdjudicator *NitroAdjudicator) PackStatusOf(arg0 [32]byte) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("statusOf", arg0)
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackStatusOf(data []byte) ([32]byte, error) {
	out, err := _NitroAdjudicator.abi.Unpack("statusOf", data)
...
// Transfer is a free data retrieval call binding the contract method 0x3033730e.
//
...
func (_NitroAdjudicator *NitroAdjudicator) PackTransfer(assetIndex *big.Int, fromChannelId [32]byte, outcomeBytes []byte, stateHash [32]byte, indices []*big.Int) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("transfer", assetIndex, fromChannelId, outcomeBytes, stateHash, indices)
}

// TransferAllAssets is a free data retrieval call binding the contract method 0x31afa0b4.
//
...
func (_NitroAdjudicator *NitroAdjudicator) PackTransferAllAssets(channelId [32]byte, outcome []ExitFormatSingleAssetExit, stateHash [32]byte) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("transferAllAssets", channelId, outcome, stateHash)
}
...
func (_NitroAdjudicator *NitroAdjudicator) PackUnpackStatus(channelId [32]byte) ([]byte, error) {
	return _NitroAdjudicator.abi.Pack("unpackStatus", channelId)
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackUnpackStatus(data []byte) (struct {
	TurnNumRecord *big.Int
	FinalizesAt   *big.Int
	Fingerprint   *big.Int
}, error) {
	out, err := _NitroAdjudicator.abi.Unpack("unpackStatus", data)
...
func (_NitroAdjudicator *NitroAdjudicator) AllocationUpdatedEventID() common.Hash {
	return common.HexToHash("0xb3917fd12b23b8d48703d554ab284c5b1912bb5c67e710c7534a56c130637679")
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackAllocationUpdatedEvent(log *types.Log) (*NitroAdjudicatorAllocationUpdated, error) {
	event := "AllocationUpdated"
	if log.Topics[0] != _NitroAdjudicator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(NitroAdjudicatorAllocationUpdated)
	if len(log.Data) > 0 {
		if err := _NitroAdjudicator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
	}
	var indexed abi.Arguments
	for _, arg := range _NitroAdjudicator.abi.Events[event].Inputs {
		if arg.Indexed {
...
func (_NitroAdjudicator *NitroAdjudicator) ChallengeClearedEventID() common.Hash {
	return common.HexToHash("0x07da0a0674fb921e484018c8b81d80e292745e5d8ed134b580c8b9c631c5e9e0")
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackChallengeClearedEvent(log *types.Log) (*NitroAdjudicatorChallengeCleared, error) {
	event := "ChallengeCleared"
	if log.Topics[0] != _NitroAdjudicator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(NitroAdjudicatorChallengeCleared)
	if len(log.Data) > 0 {
		if err := _NitroAdjudicator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
func (_NitroAdjudicator *NitroAdjudicator) ChallengeRegisteredEventID() common.Hash {
	return common.HexToHash("0x0e6d8300485cb09fa95f22b89b46f7b0cc3029f1bbf257a0884414d415546cf8")
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackChallengeRegisteredEvent(log *types.Log) (*NitroAdjudicatorChallengeRegistered, error) {
	event := "ChallengeRegistered"
	if log.Topics[0] != _NitroAdjudicator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(NitroAdjudicatorChallengeRegistered)
	if len(log.Data) > 0 {
		if err := _NitroAdjudicator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
func (_NitroAdjudicator *NitroAdjudicator) ConcludedEventID() common.Hash {
	return common.HexToHash("0x4f465027a3d06ea73dd12be0f5c5fc0a34e21f19d6eaed4834a7a944edabc901")
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackConcludedEvent(log *types.Log) (*NitroAdjudicatorConcluded, error) {
	event := "Concluded"
	if log.Topics[0] != _NitroAdjudicator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(NitroAdjudicatorConcluded)
	if len(log.Data) > 0 {
		if err := _NitroAdjudicator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
func (_NitroAdjudicator *NitroAdjudicator) DepositedEventID() common.Hash {
	return common.HexToHash("0x87d4c0b5e30d6808bc8a94ba1c4d839b29d664151551a31753387ee9ef48429b")
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackDepositedEvent(log *types.Log) (*NitroAdjudicatorDeposited, error) {
	event := "Deposited"
	if log.Topics[0] != _NitroAdjudicator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(NitroAdjudicatorDeposited)
	if len(log.Data) > 0 {
		if err := _NitroAdjudicator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
func (_NitroAdjudicator *NitroAdjudicator) ReclaimedEventID() common.Hash {
	return common.HexToHash("0x4d3754632451ebba9812a9305e7bca17b67a17186a5cff93d2e9ae1b01e3d27b")
}

func (_NitroAdjudicator *NitroAdjudicator) UnpackReclaimedEvent(log *types.Log) (*NitroAdjudicatorReclaimed, error) {
	event := "Reclaimed"
	if log.Topics[0] != _NitroAdjudicator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(NitroAdjudicatorReclaimed)
	if len(log.Data) > 0 {
		if err := _NitroAdjudicator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
