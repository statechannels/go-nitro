...
func TestUpdate(t *testing.T) {
	...
	updatedObjective, err = s.UpdateWithChainEvent(chainservice.NewDepositedEvent(types.Destination{}, highBlockNum, common.Address{}, big.NewInt(3)))
	if err != nil {
		t.Error(err)
	}
	updated = updatedObjective.(*Objective)
	...
	updatedObjective, _ = updated.UpdateWithChainEvent(chainservice.NewDepositedEvent(types.Destination{}, uint64(lowBlockNum), common.Address{}, big.NewInt(2)))
