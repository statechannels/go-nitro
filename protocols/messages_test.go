...
func removeProposal() consensus_channel.SignedProposal {
	remove := consensus_channel.NewRemoveProposal(types.Destination{'l'}, 2, types.Destination{'a'}, big.NewInt(1), big.NewInt(2))
