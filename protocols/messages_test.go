...
func TestMessage(t *testing.T) {
	...
	voucher, _ := payments.NewSignedVoucher(types.Destination{'d'}, big.NewInt(123), testactors.Alice.PrivateKey)
	msg := Message{
		To: types.Address{'a'},
